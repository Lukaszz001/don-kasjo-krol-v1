...
<section className="w-full mb-12">
  ...
  {/* Poker Banner */}
  <div className="w-full bg-gradient-to-br from-[#ffffff] via-[#e5e5e5] to-[#cccccc] rounded-3xl p-8 flex flex-col md:flex-row items-center gap-6 shadow-xl border border-[#d9d9d9]/60">
    <div className="flex-shrink-0 flex flex-col items-center w-40">
      <Image src="/poker.png" alt="Poker Logo" width={200} height={200} className="mb-2" />
    </div>
    <div className="flex-1 flex flex-col gap-2">
      <div className="bg-[#f0f0f0]/80 rounded-xl px-4 py-2 text-center text-lg font-bold mb-2 text-gray-900 drop-shadow-[0_1px_4px_#b0b0b0cc]">
    ...
    <div className="flex flex-col gap-2 w-40 relative">
      ...
      <button
        className="bg-gradient-to-r from-[#ffffff] via-[#e5e5e5] to-[#cccccc] cursor-pointer hover:from-[#cccccc] hover:to-[#ffffff] text-gray-900 rounded-full px-4 py-2 font-bold text-sm drop-shadow-[0_1px_4px_#b0b0b0cc] border border-gray-300 border-opacity-80 border-[1.5px] transition-all duration-300 group-hover:scale-105 group-active:scale-95"
        type="button"
        onClick={handleCopy}
      >
        {copied ? "Skopiowano" : "KOD: KASJO"}
      </button>
      <a href="https://tracking.wptpartners.com/visit/?bta=36435&nci=10501" className="group" target="_blank">
        <button className="bg-gradient-to-r from-[#ffffff] via-[#e5e5e5] to-[#cccccc] cursor-pointer hover:from-[#cccccc] hover:to-[#ffffff] text-gray-900 rounded-full px-4 py-2 font-bold text-sm drop-shadow-[0_1px_4px_#b0b0b0cc] border border-gray-300 border-opacity-80 border-[1.5px] transition-all duration-300 group-hover:scale-105 group-active:scale-95">
          Odbierz bonusy →
        </button>
      </a>
